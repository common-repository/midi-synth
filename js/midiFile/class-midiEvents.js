/**
 * Description: Read and edit events from various sources (ArrayBuffer, Stream)
 *
 * @package     midi-Synth
 * @category    class js
...
// Static constants
// Event types
const EVENT_META = 0xff;                        //255
const EVENT_SYSEX = 0xf0;                       //240
const EVENT_DIVSYSEX = 0xf7;                    //247
const EVENT_MIDI = 0x8;                         //8
// Meta event types
const EVENT_META_SEQUENCE_NUMBER = 0x00;        //0
const EVENT_META_TEXT = 0x01;                   //1
const EVENT_META_COPYRIGHT_NOTICE = 0x02;       //2
const EVENT_META_TRACK_NAME = 0x03;             //3
const EVENT_META_INSTRUMENT_NAME = 0x04;        //4
const EVENT_META_LYRICS = 0x05;                 //5
const EVENT_META_MARKER = 0x06;                 //6
const EVENT_META_CUE_POINT = 0x07;              //7
const EVENT_META_MIDI_CHANNEL_PREFIX = 0x20;    //32
const EVENT_META_END_OF_TRACK = 0x2f;           //47
const EVENT_META_SET_TEMPO = 0x51;              //81
const EVENT_META_SMTPE_OFFSET = 0x54;
const EVENT_META_TIME_SIGNATURE = 0x58;         //88
const EVENT_META_KEY_SIGNATURE = 0x59;          //89
const EVENT_META_SEQUENCER_SPECIFIC = 0x7f;     //127
// MIDI event types
const EVENT_MIDI_NOTE_OFF = 0x8;                //8
const EVENT_MIDI_NOTE_ON = 0x9;                 //9
const EVENT_MIDI_NOTE_AFTERTOUCH = 0xa;         //10
const EVENT_MIDI_CONTROLLER = 0xb;              //11
const EVENT_MIDI_PROGRAM_CHANGE = 0xc;          //12
const EVENT_MIDI_CHANNEL_AFTERTOUCH = 0xd;      //13
const EVENT_MIDI_PITCH_BEND = 0xe;              //14
// MIDI event sizes
...
class MIDIEvents {
  ...
  static get EVENT_META() {
    return EVENT_META;
  }
  static get EVENT_SYSEX() {
    return EVENT_SYSEX;
  }
  static get EVENT_DIVSYSEX() {
    return EVENT_DIVSYSEX;
  }
  static get EVENT_MIDI() {
    return EVENT_MIDI;
  }

  static get EVENT_META_SEQUENCE_NUMBER() {
    return EVENT_META_SEQUENCE_NUMBER;
  }
  static get EVENT_META_TEXT() {
    return EVENT_META_TEXT;
  }
  static get EVENT_META_COPYRIGHT_NOTICE() {
    return EVENT_META_COPYRIGHT_NOTICE;
  }
  static get EVENT_META_TRACK_NAME() {
    return EVENT_META_TRACK_NAME;
  }
  static get EVENT_META_INSTRUMENT_NAME() {
    return EVENT_META_INSTRUMENT_NAME;
  }
  static get EVENT_META_LYRICS() {
    return EVENT_META_LYRICS;
  }
  static get EVENT_META_MARKER() {
    return EVENT_META_MARKER;
  }
  static get EVENT_META_CUE_POINT() {
    return EVENT_META_CUE_POINT;
  }
  static get EVENT_META_MIDI_CHANNEL_PREFIX() {
    return EVENT_META_MIDI_CHANNEL_PREFIX;
  }
  static get EVENT_META_END_OF_TRACK() {
    return EVENT_META_END_OF_TRACK;
  }
  static get EVENT_META_SET_TEMPO() {
    return EVENT_META_SET_TEMPO;
  }
  static get EVENT_META_SMTPE_OFFSET() {
    return EVENT_META_SMTPE_OFFSET;
  }
  static get EVENT_META_TIME_SIGNATURE() {
    return EVENT_META_TIME_SIGNATURE;
  }
  static get EVENT_META_KEY_SIGNATURE() {
    return EVENT_META_KEY_SIGNATURE;
  }
  static get EVENT_META_SEQUENCER_SPECIFIC() {
    return EVENT_META_SEQUENCER_SPECIFIC;
  }

  static get EVENT_MIDI_NOTE_OFF() {
    return EVENT_MIDI_NOTE_OFF;
  }
  static get EVENT_MIDI_NOTE_ON() {
    return EVENT_MIDI_NOTE_ON;
  }
  static get EVENT_MIDI_NOTE_AFTERTOUCH() {
    return EVENT_MIDI_NOTE_AFTERTOUCH;
  }
  static get EVENT_MIDI_CONTROLLER() {
    return EVENT_MIDI_CONTROLLER;
  }
  static get EVENT_MIDI_PROGRAM_CHANGE() {
    return EVENT_MIDI_PROGRAM_CHANGE;
  }
  static get EVENT_MIDI_CHANNEL_AFTERTOUCH() {
    return EVENT_MIDI_CHANNEL_AFTERTOUCH;
  }
  static get EVENT_MIDI_PITCH_BEND() {
    return EVENT_MIDI_PITCH_BEND;
  }

  static get MIDI_1PARAM_EVENTS() {
    return MIDI_1PARAM_EVENTS;
  }
  static get MIDI_2PARAMS_EVENTS() {
    return MIDI_2PARAMS_EVENTS;
  }
   ...
   * @param  {[type]} strictMode [description]
   * @return {[type]}            [description]
   */
  createParser(stream, startAt, strictMode ) {
    // Private vars
    // Common vars
    var eventTypeByte;
    var event;
   ...
   * @return {[type]}             [description]
   */
  writeToTrack(events, destination, strictMode) {
    var index = 0;
    var i;
    var j;
    var k;
   ...
   * @return {[type]}        [description]
   */
  getRequiredBufferLength(events) {
    var bufferLength = 0;
    var i = 0;
    var j;
