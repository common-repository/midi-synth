/**
 * Description: UTF-8 encoder/decoder
 *
 * @package     midi-Synth
 * @category    class js
...
class UTF8 {
   ...
   * @param  {[type]}  byteOffset [description]
  ...
  /**
   * [getCharLength description]
   * @param  {[type]} theByte [description]
   * @return {[type]}         [description]
   */
  ...
  /**
   * [getStringFromBytes description]
   * @param  {[type]} bytes      [description]
   * @param  {[type]} byteOffset [description]
   * @param  {[type]} byteLength [description]
  ...
  /**
   * UTF8 encoding
   * @param  {[type]} charCode [description]
   * @return {[type]}          [description]
   */
  ...
  /**
   * [setBytesFromCharCode description]
   * @param {[type]} charCode    [description]
   * @param {[type]} bytes       [description]
   * @param {[type]} byteOffset  [description]
   * @param {[type]} neededBytes [description]
   */
  ...
  /**
   * [setBytesFromString description]
