/**
 * Description: WebAudio Controls of Synthesizer.
 *
 * @package     midi-Synth
 * @category    module js
...
/**
 * Default values for  WebAudioControls.
 *
 * @var object
 */
var WebAudioControlsOptions = {
  useMidi:1,
  midilearn:1,
  preserveMidiLearn:1,
};
...
<input class='webaudio-param-body' name='webaudio-prm' value='0' tabindex='1' touch-action='none'/><div class='webaudioctrl-tooltip'></div>
`;
      this.elem=root.childNodes[2];
